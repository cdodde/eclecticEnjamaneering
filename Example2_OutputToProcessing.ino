...
void setup()
{
  ...
  //MLX90640_SetRefreshRate(MLX90640_address, 0x05); //Set rate to 4Hz
...
double arr1[32][24];
  for (int x = 0 ; x < 768 ; x++){
    ...
    if(x % 32 == 0) {
     ...
     arr1[row][col]=mlx90640To[x]*9.0/5.0+32.0; //convert from c to f
     //Serial.print(arr[row][col], 0);
     if (arr1[row][col]<78 )
     {Serial.print(0);} //print below threshold
      arr1[row][col] = 0;
     else 
     {
      Serial.print(1); //
